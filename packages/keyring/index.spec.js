...
var _setPrefix = _interopRequireDefault(require('./address/setPrefix'));
...
describe('keypair', () => {
  ...
  describe('ed25519', () => {
    ...
    it('creates a ed25519 pair via mnemonicToSeed', () => {
      expect(
        keypair.addFromUri('seed sock milk update focus rotate barely fade car face mechanic mercy').address()
    ...
    it('adds from a mnemonic', () => {
      ...
      expect(
        keypair
          .addFromMnemonic('moral movie very draw assault whisper awful rebuild speed purity repeat card', {})
          .address()
    ...
    it('allows adding from JSON', () => {
      expect(
        keypair
          .addFromJson(
            JSON.parse(
              '{"address":"5GoKvZWG5ZPYL1WUovuHW3zJBWBP5eT8CbqjdRY4Q6iMaQua","encoded":"0xb4a14995d25ab609f3686e9fa45f1fb237cd833f33f00d4b12c51858ca070d96972e47d73aae5eeb0fc06f923826cf0943fdb02c2c2ee30ef52a7912663053940d1da4da66b3a3f520ae07422c1c94b2d95690fca9d1f4a997623bb2923a8833280e19e7f72c3c5cfa343974e60e2b3dc53b404fdaf330756daad5e4e3","encoding":{"content":"pkcs8","type":"xsalsa20-poly1305","version":"0"},"meta":{"isTesting":true,"name":"alice"}}'
            )
          )
          .publicKey()
      ).toEqual(
  ...
  describe('sr25519', () => {
    ...
    it('creates with dev phrase when only path specified', () => {
      expect(keypair.createFromUri('//Alice').address()).toEqual('5GrwvaEF5zXb26Fz9rcQpDWS57CtERHpNehXCPcNoHGKutQY');
    });
    it('adds the pair', () => {
      expect(keypair.addFromSeed(seedTwo, {}).publicKey()).toEqual(publicKeyTwo);
    });
