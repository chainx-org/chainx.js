...
// As per substrate
const SEEDS = ['Alice', 'Alice//stash', 'Bob', 'Charlie', 'Dave', 'Eve', 'Ferdie']; // NOTE This is not great, but a testing keyring is for testing - what happens is that in most cases
...
const PAIRS = [
  [
    ...
    (0, _util.hexToU8a)('0xd43593c715fdd31c61141abd04a99fd6822c8558854ccde39a5684e7a56da27d'),
  ],
  [
    (0, _util.hexToU8a)(
    ...
    (0, _util.hexToU8a)('0xbe5ddb1579b72e84524fc29e78609e3caf42e85aa118ebfe0b0ad404b5bdd25f'),
  ],
  [
    (0, _util.hexToU8a)(
  ...
  [
    ...
    (0, _util.hexToU8a)('0xe659a7a1628cdd93febc04a4e0646ea20e9f5f0ce097d9a05290d4a9e054df4e'),
  ],
  [
    (0, _util.hexToU8a)(
