...
export default class Address extends Base {
  ...
  static decodeAddress(value) {
    ...
    return decoded.length === 32 ? new AccountId(decoded) : new AccountIndex(u8aToBn(decoded, true));
  }
  /**
   ...
   */
  get rawLength() {
    return this.raw instanceof AccountIndex ? AccountIndex.calcLength(this.raw) : this.raw.encodedLength;
  }
  /**
  ...
  toU8a(isBare) {
    ...
    return isBare
      ? encoded
      : u8aConcat(this.raw instanceof AccountIndex ? AccountIndex.writeLength(encoded) : ACCOUNT_ID_PREFIX, encoded);
  }
}
