...
describe.skip('Extrinsic', () => {
  ...
  it('decodes an actual transaction with indexes', () => {
    const extrinsic = new Extrinsic(
      ''
    );
    expect(extrinsic.isSigned).toEqual(true);
    expect(extrinsic.signature.signer.toU8a()).toEqual(new Uint8Array([0x10]));
    expect(extrinsic.signature.signature.toHex()).toEqual(
      '0xf8e1ebdd3cdef7423d24fe68f3863945ea21c190907d7f3394ddf153f633c77b894af36f7a36e7ec767f4593bfd8d084b66d805605905054327a08ff60418708'
    );
    expect(extrinsic.signature.nonce.toNumber()).toEqual(0);
