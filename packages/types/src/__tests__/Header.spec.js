...
describe.skip('Header', () => {
  it('decodes an actual JSON response', () => {
    ...
    expect(header.extrinsicsRoot.toString()).toEqual(
  ...
  it('creates a valid hash (incl. digest & compact)', () => {
    ...
    expect(header.hash.toHex()).toEqual('0x63ccfdc044d3ff4c915ad01c0d57d2ff807f4eb7d60cd41584917363bc83a99f');
    expect(header.blockNumber.eq(new BN(2918))).toBe(true);
  });
});
