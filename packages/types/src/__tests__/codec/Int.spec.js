...
describe('Int', () => {
  it('provides a toBn interface', () => {
    expect(new Int(-1234).toBn().toNumber()).toEqual(-1234);
  });
  it('provides a toNumber interface', () => {
    expect(new Int(-1234).toNumber()).toEqual(-1234);
  });
  it('converts to LE from the provided value', () => {
    expect(new Int(-1234).toU8a()).toEqual(new Uint8Array([46, 251, 255, 255, 255, 255, 255, 255]));
  });
  it('converts to LE from the provided value (bitLength)', () => {
    expect(new Int(-1234, 32).toU8a()).toEqual(new Uint8Array([46, 251, 255, 255]));
  });
  ...
  it('converts to equivalents', () => {
    const a = new Int('-123');
    expect(new Int(a).toNumber()).toEqual(-123);
  });
