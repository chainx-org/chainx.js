...
describe('UInt', () => {
  it('provides a toBn interface', () => {
    expect(new UInt(987).toBn().toNumber()).toEqual(987);
  });
  it('provides a toNumber interface', () => {
    expect(new UInt(4567).toNumber()).toEqual(4567);
  });
  it('converts to LE from the provided value', () => {
    expect(new UInt(1234567).toU8a()).toEqual(new Uint8Array([135, 214, 18, 0, 0, 0, 0, 0]));
  });
  it('converts to LE from the provided value (bitLength)', () => {
    expect(new UInt(1234567, 32).toU8a()).toEqual(new Uint8Array([135, 214, 18, 0]));
  });
  ...
  it('converts to equivalents', () => {
    ...
    expect(new UInt(a).toNumber()).toEqual(123);
  });
