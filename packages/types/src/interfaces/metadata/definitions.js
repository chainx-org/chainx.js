...
export default {
  types: {
    ...
    EventMetadataLatest: 'EventMetadataV5',
    FunctionArgumentMetadataLatest: 'FunctionArgumentMetadataV5',
    FunctionMetadataLatest: 'FunctionMetadataV5',
    ModuleConstantMetadataLatest: 'ModuleConstantMetadataV5',
    PlainTypeLatest: 'PlainTypeV5',
    StorageEntryModifierLatest: 'StorageEntryModifierV5',
  },
};
