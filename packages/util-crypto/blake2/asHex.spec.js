...
describe('blake2AsHex', () => {
  ...
  it('returns a 64-bit value (specified)', () => {
    expect((0, _.blake2AsHex)('abc', 64)).toEqual('0xd8bb14d833d59559');
  });
  it('returns a 128-bit value (as specified)', () => {
    expect((0, _.blake2AsHex)('abc', 128)).toEqual('0xcf4ab791c62b8d2b2109c90275287816');
  });
  it('returns a 256-bit value (default)', () => {
    expect((0, _.blake2AsHex)('abc')).toEqual('0xbddd813c634239723171ef3fee98579b94964e3bb1cb3e427262c8c068d52319');
  });
  it('returns a 512-bit value (as specified)', () => {
    expect((0, _.blake2AsHex)('abc', 512)).toEqual(
