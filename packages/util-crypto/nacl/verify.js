 ...
 *
 * ```javascript
 * import { naclVerify } from '@chainx/util-crypto';
 *
...
function naclVerify(message, signature, publicKey) {
  ...
  return (0, _wasmCrypto.isReady)()
    ? (0, _wasmCrypto.ed25519Verify)(signatureU8a, messageU8a, publicKeyU8a)
    : _tweetnacl.default.sign.detached.verify(messageU8a, signatureU8a, publicKeyU8a);
}
